	...
	FProjectWorldRealizationResult& OutResult)
{
	...
	if (!ProjectWorldGeneratedGeometry::RemoveOwnedActors(World, bPreserveLandscape, OutResult))
	{
	...
	if (Request.Mode == EProjectWorldRealizationMode::Apply)
	{
		...
		if (Layout.bCompatible &&
			!ProjectWorldLandscapeRealization::CreateOrUpdate(World, Bundle, Layout, OutResult, EditorError))
		{
