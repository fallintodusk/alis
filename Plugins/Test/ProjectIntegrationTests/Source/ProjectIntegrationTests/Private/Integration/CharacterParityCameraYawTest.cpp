...
struct FCameraYawPhase
{
	...
	bool bExpectYawResponse;
	bool bExpectLargeBodyTurn;
	bool bExpectTurnState;
};

static const FCameraYawPhase GCameraYawPhases[] = {
	{ TEXT("IdleSettle"),        1.0f, {0, 0},   false,   0.f,   0.f, false, false, false },
	{ TEXT("IdleYaw30"),         1.0f, {0, 0},   false,   0.f,  30.f, true,  false, false },
	{ TEXT("IdleYaw60"),         1.0f, {0, 0},   false,  30.f,  60.f, true,  true,  false },
	{ TEXT("IdleYaw100"),        1.0f, {0, 0},   false,  60.f, 100.f, true,  true,  true  },
	{ TEXT("IdleHold100"),       1.0f, {0, 0},   false, 100.f, 100.f, false, false, false },
	{ TEXT("IdleBackTo0"),       1.0f, {0, 0},   false, 100.f,   0.f, true,  true,  true  },
	{ TEXT("MoveForward"),       2.0f, {1, 0},   false,   0.f,   0.f, false, false, false },
	{ TEXT("MoveForwardYaw90"),  2.0f, {1, 0},   false,   0.f,  90.f, true,  true,  false },
	{ TEXT("StrafeLeft"),        1.5f, {0, -1},  false,   0.f,   0.f, false, false, false },
	{ TEXT("StrafeRight"),       1.5f, {0, 1},   false,   0.f,   0.f, false, false, false },
	{ TEXT("CrouchIdleYaw90"),   1.5f, {0, 0},   true,    0.f,  90.f, true,  true,  true  },
	{ TEXT("CrouchForwardYaw"),  1.5f, {1, 0},   true,   90.f, 180.f, true,  true,  false },
	{ TEXT("StopFinal"),         1.0f, {0, 0},   false, 180.f, 180.f, false, false, false },
};
static constexpr int32 GNumCameraYawPhases = UE_ARRAY_COUNT(GCameraYawPhases);
...
void UpdateYawSummary(
	FCameraYawPhaseSummary& Summary,
	float ActorYaw,
	float ControlYaw,
	float Speed2D,
...
void FinalizeYawSummary(FCameraYawPhaseSummary& Summary)
{
...
TSharedPtr<FJsonObject> YawSummaryToJson(const FCameraYawPhaseSummary& Summary)
{
	TSharedPtr<FJsonObject> Object = MakeShared<FJsonObject>();
...
class FCameraYawTimelineCommand : public IAutomationLatentCommand
{
public:
...
private:
	...
	bool WaitForDefinitionCharacter()
	{
		...
		if (Tick > 1800)
		{
			Test->AddError(TEXT("Timed out waiting for DefinitionCharacter"));
			return true;
		}
	...
	bool RunPhases(const TCHAR* RuntimeModelLabel)
	{
		...
		const FCameraYawPhase& Phase = GCameraYawPhases[PhaseIdx];
		...
		if (!bPhaseStarted)
		{
			...
			Summary.bExpectYawResponse = Phase.bExpectYawResponse;
		...
		int32 SampleIdx)
	{
		...
		Row->SetStringField(TEXT("VisibleMeshName"), OwnerVisible.Name);
		Row->SetStringField(TEXT("VisibleMeshLeaderPose"), OwnerVisible.LeaderPose);
		...
		Row->SetObjectField(TEXT("OwnerVisibleMesh"), MeshSampleToJson(OwnerVisible));
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FCharacterParityCameraYawTest,
	"ProjectIntegrationTests.Character.Parity.CameraYawTimeline",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::ProductFilter)

bool FCharacterParityCameraYawTest::RunTest(const FString& Parameters)
{
	ADD_LATENT_AUTOMATION_COMMAND(CameraYawHelpers::FCameraYawTimelineCommand(this));
	return true;
}
