...
namespace ProjectTags
{
	...
	PROJECTCORE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Scenario_HandymanDoor);
	PROJECTCORE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Scenario_FamilyApartmentDoor);
	PROJECTCORE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Scenario_LuxuryApartmentDoor);
}
