...
**Scope:** Universal generated-World water presentation; Kazan is the first production
and Shipping fixture, not the owner or a runtime branch.
...
**Concrete geography owner:** Each territory data owner; ProjectWorldData owns Kazan
polygons, elevations, behavior, and sourced semantic facts only
...
- Epic Water, WaterBody actors, zones, splines, Epic Water landscape carving, or runtime queries;
...
This presentation packet does not own Terrain/Water vertical alignment. The stable
ProjectWorld realization contract hydro-conditions the generated Landscape projection
under canonical Water while preserving both canonical authorities. Future material work
must consume that projection and must not replace it with a second Water or Landscape owner.
