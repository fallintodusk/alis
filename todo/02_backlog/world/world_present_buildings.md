# Present World buildings

**Status:** RESEARCH COMPLETE / IMPLEMENTATION NOT SELECTED
**Scope:** Universal generated-World building presentation; Kazan is the first measured
...
**Concrete geography owner:** Each territory data owner; ProjectWorldData owns those facts
for the Kazan fixture only
...
Make accepted generated building massing read clearly as a city at player, oblique, and
aerial views while remaining an honest blockout. Kazan is the first acceptance fixture:
...
- [Shared material core](../../01_done/content/material_generate_assets_from_json.md)
