# Present World vegetation

**Status:** RESEARCH COMPLETE / IMPLEMENTATION NOT SELECTED
**Scope:** Universal generated-World vegetation realization/presentation; Kazan is the
first production fixture, not the owner or a code branch.
**R1:** PASS - 2026-08-26
...
**Concrete configuration owner:** Each territory data owner; ProjectWorldData owns the
Kazan realization profile only
**Concrete mesh owner:** ProjectObject content
**Operator sequencing prerequisite:** [Shared material generation core](../../01_done/content/material_generate_assets_from_json.md)
...
Make vegetation in generated territories frequent and varied enough to sell each
