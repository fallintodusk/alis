...
**Status:** LEGACY 1.0.0 PLAN - NOT THE CURRENT RELEASE ROUTER
**Current release:** [ALIS 2.0.0](../../00_current/00_release_2.0.0.md)

Anything that blows the scope gets cut -- no exceptions.

This file preserves the 1.0.0 scope history. Current product focus and execution
routing are owned by the 2.0.0 release router above.
...
| ~~11~~ | ~~Lumen striations/stripes visible when moving camera ([details](../rendering/strafe_artifacts_fix.md))~~ | ~~Rendering~~ |
| ~~12~~ | ~~Implement poison gas cloud - environmental hazard via GAS~~ | ~~Vitals~~ |
...
| ~~15~~ | ~~Broken `BP_Hero` DefaultPawnClass paths in SinglePlayModeDefaults ([details](../test/16.04.26_test_report.md))~~ | ~~Packaging~~ |
