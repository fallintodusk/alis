...
**Status:** PRODUCT ACCEPTED - MACHINE AND OPERATOR PASS
**Track:** P only - packaged playable tour
**Research:** Complete; R2 PASS
**Implementation:** Complete; exact product identity is owner-generated evidence
...
This todo owns Track P only and is complete. Future authored footage is a separate
Release 2.0.0 concern and does not reopen packaged-tour acceptance.
...
- [Seven-concern selection](world_research_kazan_ue58_presentation.md)
- [Presentation campaign](world_plan_kazan_presentation_campaign.md)
...
Corrected (historical implementation routing):

- `todo/00_current/` is flat by repository contract. During implementation the flat
  current path was correct; after operator acceptance this unchanged filename moved to
  `todo/01_done/world/`.
