# Run-Tests.ps1 - Test runner for config loading tests
#
# Usage:
#   powershell scripts/config/test/Run-Tests.ps1
#   powershell scripts/config/test/Run-Tests.ps1 -Detailed
#   powershell scripts/config/test/Run-Tests.ps1 -InstallPester
...
Write-Host "Config Loading Tests (Pester)" -ForegroundColor Cyan
Write-Host "======================================" -ForegroundColor Cyan
Write-Host ""
...
if (-not $pesterModule) {
    ...
    if ($InstallPester) {
        ...
        Write-Host "  powershell scripts/config/test/Run-Tests.ps1 -InstallPester" -ForegroundColor Yellow
        Write-Host ""
