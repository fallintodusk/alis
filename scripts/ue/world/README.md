...
The two executable v1 pairs are complete contracts, not ID-only dispatch:
Landscape owns terrain canonical cells and water owns water-only canonical
cell semantics. Operator cell IDs are checked against the current domain,
